...
TMP_APK="/data/local/tmp/OneStep40.apk"
TMP_XML="/data/local/tmp/privapp-permissions-onestep.xml"
SYSTEM_APK_DIR="/system/priv-app/OneStep40"
SYSTEM_APK="$SYSTEM_APK_DIR/OneStep40.apk"
...
echo "Installed OneStep40 as priv-app through $ROOT_MODE. Device is rebooting."
